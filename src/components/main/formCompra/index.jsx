...
const FormCompra = ({producto, infoProduct}) => {
    ...
    return (
        <Form className = 'producto__formCompra col-xl-3'>
            ...
            {(infoProduct && infoProduct.shipping.free_shipping) ? 
