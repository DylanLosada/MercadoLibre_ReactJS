...
const Carrito = () => {
    ...
    const {carrito, addQuantity, lessQuantity, setQuantity, deleteProduct} = useContext(GlobalContext)
    ...
    const handleFinishBuy = () => console.log(history.pathname)
                ...
                {carrito.length > 0 ? 
                    <div className = 'w-100'>
                        ...
                        <CarritoCounter 
                            ...
                            handleFinishBuy = {handleFinishBuy}
                        />
                    </div>
                 : <div className = 'carritoContainer__empty'>
                        <h1 className = 'carritoContainer__empty-title'>Tu carrito está vacío</h1>
                    </div>}
            </div>
        </section>
    )
